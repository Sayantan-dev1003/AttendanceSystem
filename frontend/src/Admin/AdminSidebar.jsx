    ...
    return (
        <div className="w-1/6 p-2 bg-[#00416A] text-white poppins text-base">
            ...
            <ul className='flex flex-col w-full gap-1'>
                <li onClick={() => handleLinkClick('dashboardAdmin') } className={`p-2 cursor-pointer hover:bg-[#0064a2] rounded-md transition ${activeLink === 'dashboardAdmin' ? 'active bg-[#0064a2]' : ''}`}>
                    <div>Dashboard</div>
                </li>

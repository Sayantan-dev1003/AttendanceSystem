...
const AdminSettings = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-start items-start p-6 poppins">
      ...
      <div className="flex gap-10 items-start w-full justify-start bg-[#e7f6ff] rounded-2xl p-4 mb-8 shadow-lg">
        <div className="">
          <img
      ...
      <div className="w-full text-sm p-5 bg-[#e7f6ff] rounded-2xl shadow-2xl">
        <p className="text-lg font-medium border-b pb-1.5 mb-4">User Details</p>
